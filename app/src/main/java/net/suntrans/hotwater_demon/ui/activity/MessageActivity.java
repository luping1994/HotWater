...
import net.suntrans.hotwater_demon.database.AppDatabase;
import net.suntrans.hotwater_demon.database.DatabaseUtils;
import net.suntrans.hotwater_demon.databinding.ActivityHisBinding;
