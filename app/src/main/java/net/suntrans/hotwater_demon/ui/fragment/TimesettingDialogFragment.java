...
import net.suntrans.hotwater_demon.api.Api;
import net.suntrans.hotwater_demon.api.RetrofitHelper;
import net.suntrans.hotwater_demon.bean.CmdMsg;
import net.suntrans.hotwater_demon.bean.Read4;
import net.suntrans.hotwater_demon.bean.Read4Entity;
import net.suntrans.hotwater_demon.databinding.FragmentTimesettingBinding;
