package net.suntrans.hotwater_demon.utils;
...
import net.suntrans.hotwater_demon.bean.Message;
import net.suntrans.hotwater_demon.ui.activity.MessageActivity;
